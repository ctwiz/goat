class Api::EarningsController < ApplicationController
  ...
  def create
    ...
    if @earning.blank?
      ...
      Earning.update(@earning.id, eps_forecast: params["eps_forecast"], last_year_eps: params["last_year_eps"], reporting_date: date_format(params["reporting_date"]))
    end
    render json: @earning
  end
